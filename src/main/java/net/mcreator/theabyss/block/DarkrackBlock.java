...
public class DarkrackBlock extends TheAbyssModElements.ModElement {
	@ObjectHolder("the_abyss:darkrack")
	public static final Block block = null;

	public DarkrackBlock(TheAbyssModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.NETHERRACK).hardnessAndResistance(18f, 20f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("darkrack");
		}
