...
public class AbyssframeBlock extends TheAbyssModElements.ModElement {
	@ObjectHolder("the_abyss:abyssframe")
	public static final Block block = null;

	public AbyssframeBlock(TheAbyssModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.BONE).hardnessAndResistance(10f, 30f).setLightLevel(s -> 0));
			setRegistryName("abyssframe");
		}
