...
package net.mcreator.theabyss.world.biome;
...
import net.mcreator.theabyss.entity.DarkZombiesEntity;
import net.mcreator.theabyss.block.TreeBoneLogBlock;
import net.mcreator.theabyss.block.TreeBoneLeavesBlock;
import net.mcreator.theabyss.block.BoneforstrackBlock;
import net.mcreator.theabyss.block.BoneforestrackBlock;
...
public class DarkForestBiome extends TheAbyssModElements.ModElement {
	public static Biome biome;

	public DarkForestBiome(TheAbyssModElements instance) {
		super(instance, 8);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-13172662).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-13172662).withFoliageColor(10387789).withGrassColor(9470285).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(BoneforestrackBlock.block.getDefaultState(),
								BoneforstrackBlock.block.getDefaultState(), BoneforstrackBlock.block.getDefaultState())));
				...
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(DarkZombiesEntity.entity, 20, 4, 4));
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.1f).scale(0.2f).temperature(0.5f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("the_abyss:dark_forest"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("dark_forest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("dark_forest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("dark_forest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
