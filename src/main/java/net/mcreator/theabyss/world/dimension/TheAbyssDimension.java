...
package net.mcreator.theabyss.world.dimension;
...
import net.mcreator.theabyss.item.TheAbyssItem;
import net.mcreator.theabyss.block.DarkrackBlock;
...
public class TheAbyssDimension extends TheAbyssModElements.ModElement {
	@ObjectHolder("the_abyss:the_abyss_portal")
	public static final CustomPortalBlock portal = null;

	public TheAbyssDimension(TheAbyssModElements instance) {
		super(instance, 7);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(DarkrackBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("the_abyss:darkwastlands")).getGenerationSettings()
				.getSurfaceBuilder().get().getConfig().getTop().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("the_abyss:darkwastlands")).getGenerationSettings()
				.getSurfaceBuilder().get().getConfig().getUnder().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("the_abyss:dark_forest")).getGenerationSettings()
				.getSurfaceBuilder().get().getConfig().getTop().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("the_abyss:dark_forest")).getGenerationSettings()
				.getSurfaceBuilder().get().getConfig().getUnder().getBlock());
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("the_abyss:the_abyss"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void initElements() {
		...
		elements.items.add(() -> new TheAbyssItem().setRegistryName("the_abyss"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("the_abyss:the_abyss"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("the_abyss:the_abyss")));
				} else {
					entity.func_242279_ag();
	...
	public static class CustomPortalSize {
		private static final AbstractBlock.IPositionPredicate POSITION_PREDICATE = (state, blockReader, pos) -> {
			return state.getBlock() == AbyssframeBlock.block;
		};
				...
				for (int l1 = -1; l1 < 2; ++l1) {
					for (int k2 = 0; k2 < 2; ++k2) {
						for (int i3 = -1; i3 < 3; ++i3) {
							BlockState blockstate1 = i3 < 0 ? AbyssframeBlock.block.getDefaultState() : Blocks.AIR.getDefaultState();
			...
			for (int k1 = -1; k1 < 3; ++k1) {
				for (int i2 = -1; i2 < 4; ++i2) {
					if (k1 == -1 || k1 == 2 || i2 == -1 || i2 == 3) {
						...
						this.world.setBlockState(blockpos$mutable, AbyssframeBlock.block.getDefaultState(), 3);
					}
				}
			}
