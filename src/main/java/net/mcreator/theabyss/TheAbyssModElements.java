...
public class TheAbyssModElements {
	...
	public TheAbyssModElements() {
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == TheAbyssModElements.ModElement.class)
						elements.add((TheAbyssModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(TheAbyssModElements.ModElement::initElements);
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		public ModElement(TheAbyssModElements elements, int sortid) {
